...
public class LocationLayerPlugin implements LocationEngineListener, CompassListener, MapView.OnMapChangedListener,
    ...
    private void initialize() {
        ...
        attributionView = (ImageView) mapView.findViewById(com.mapbox.mapboxsdk.R.id.attributionView);
        logoView = (ImageView) mapView.findViewById(com.mapbox.mapboxsdk.R.id.logoView);
    }
   ...
   */
    ...
    /**
     * Enable / Disable logoView
     */
    public void showLogo(boolean show) {
        logoView.setVisibility((show ? View.VISIBLE : View.GONE));
    }

    /**
     * Enable / Disable attrView
     */
    public void showAttribution(boolean show) {
        attributionView.setVisibility((show ? View.VISIBLE : View.GONE));
    }
    ...
    public void setMyLocation(Location location) {
        this.forceLocationUpdate(location);
    }

    /**
     * Force tracking on current position
     */
    @SuppressWarnings( {"MissingPermission"})
    public void setMyTrackingMode(@LocationTrackingMode.Mode int mode) {
        switch (mode) {
            ...
            case LocationTrackingMode.BEARING:
                mapboxMap.getTrackingSettings().setMyLocationTrackingMode(MyLocationTracking.TRACKING_FOLLOW);
                mapboxMap.getTrackingSettings().setMyBearingTrackingMode(MyBearingTracking.COMPASS);
                this.setLocationLayerEnabled(LocationLayerMode.COMPASS);
                break;
        }
     ...
     * Render center dot
     */
    public void setRenderCenterDot(boolean render) {
